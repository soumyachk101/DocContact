    ...
    return (
        <main className="max-w-[88rem] mx-auto px-6 py-8 flex flex-col gap-6 fade-in">
            ...
            <div className="text-xs font-bold text-gray-400 flex items-center gap-1.5">
                ...
                <i className="fas fa-chevron-right text-[8px]"></i>
                <span className="text-[#252a67]">{doctor.fullName}</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-5 space-y-6">
                    <div className="card rounded-3xl p-6 bg-white border border-[#252a67]/5 shadow-sm">
                        {/* Head Details */}
                        <div className="flex items-center gap-4 border-b border-gray-100 pb-6 mb-6">
                            <div className="w-20 h-20 rounded-2xl bg-[#252a67]/10 flex-shrink-0 flex items-center justify-center text-5xl">
                                <span>{doctor.gender === 'male' ? '👨‍⚕️' : '👩‍⚕️'}</span>
                            </div>
                            <div>
                                <div className="flex items-center gap-2">
                                    <h1 className="text-xl font-black text-[#252a67] leading-tight">{doctor.fullName}</h1>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-sm font-bold text-[#252a67] border-b border-gray-50 pb-2">Chamber & Consult Info</h3>
                    ...
                    <div className="card rounded-3xl p-6 overflow-hidden relative min-h-[160px] bg-sky-50 flex items-center justify-center border border-gray-100 shadow-sm">
                        <div className="absolute inset-0 bg-[radial-gradient(#252a67_1.5px,transparent_1.5px)] [background-size:16px_16px] opacity-10"></div>
